<?php
    ...
    if($check_usuario->rowCount()==1){
    	...
    	$check_equipos=$check_equipos->query("SELECT usuario_id FROM equipo WHERE usuario_id='$user_id_del' LIMIT 1");
    	...
    	if($check_equipos->rowCount()<=0){
    		...
    		echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
	                No podemos eliminar el usuario ya que tiene equipos registrados por el
	            </div>
	        ';
    	}
    	$check_equipos=null;
